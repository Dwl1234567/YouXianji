<template>
	<u-popup :closeOnClickOverlay="maskCloseAble" mode="bottom" :show="value" :safeAreaInsetBottom="safeAreaInsetBottom"
		@close="close" :zIndex="uZIndex">
...
<script>
	import provinces from './lib/js/province.js'
	import citys from './lib/js/city.js';
	import areas from './lib/js/area.js';
