<template>
	<view>
		...
		<view :class="['content', show ? '' : 'contenthide']">
			<view class="title">
				<view class="close" @click="close()"><image src="../../static/img/close.png" /></view>
			...
			<view class="pay-way">
				<view>支付方式</view>
				<view class="pay-img"><image src="../../static/img/yue.png"/>{{paytitle}}</view>
			</view>
		...
		<view :class="['keyboard', show ? '' : 'active', isIphoneX ? 'isIphone' : '']">
			...
			<view class="keyboard-item delte" @tap="del()"><image class="img" src="../../static/img/del.png" mode="aspectFill" :lazy-load="true"></image></view>
		</view>
