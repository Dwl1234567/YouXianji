...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n\nvar _this = null;\nvar _default = {\n  data: function data() {\n    return {\n      dotype: 'idphoto',\n      //操作类型\n      message: '',\n      //提示\n      aspect: '1:1',\n      //比例\n      cameraWidth: '',\n      //相机画面宽度\n      cameraHeight: '',\n      //相机画面宽度\n      windowWidth: '',\n      //屏幕可用宽度\n      windowHeight: '',\n      //屏幕可用高度\n      camerastate: false,\n      //相机准备好了\n      livePusher: null,\n      //流视频对象\n      snapshotsrc: null //快照\n    };\n  },\n  onLoad: function onLoad(e) {\n    _this = this;\n    if (e.dotype != undefined) this.dotype = e.dotype;\n    this.initCamera();\n  },\n  onReady: function onReady() {\n    this.livePusher = uni.createLivePusherContext('livePusher', this);\n    // setTimeout(()=>{\n    this.startPreview(); //开启预览并设置摄像头\n    this.poenCarme();\n    // },500)\n  },\n\n  methods: {\n    //轮询打开\n    poenCarme: function poenCarme() {\n      if (plus.os.name == 'Android' || plus.os.name == 'iOS') {\n        this.poenCarmeInterval = setInterval(function () {\n          __f__(\"log\", _this.camerastate, \" at pages/idphoto/idphoto.nvue:71\");\n          if (!_this.camerastate) _this.startPreview();\n        }, 2500);\n      }\n      // else{\n      // \tlet poenCarmeInterval = setInterval(function() {\n      // \t\tconsole.log(_this.openCameraStatus);\n      // \t\tif (_this.openCameraStatus) {\n      // \t\t\tclearInterval(poenCarmeInterval)\n      // \t\t\treturn;\n      // \t\t}\n      // \t\t_this.startPreview();\n      // \t}, 1000);\n      // }\n    },\n    //初始化相机\n    initCamera: function initCamera() {\n      uni.getSystemInfo({\n        success: function success(res) {\n          // console.log(res)\n          _this.windowWidth = res.windowWidth;\n          _this.windowHeight = res.windowHeight;\n          _this.cameraWidth = res.windowWidth;\n          _this.cameraHeight = res.windowWidth;\n        }\n      });\n    },\n    //开始预览\n    startPreview: function startPreview() {\n      this.livePusher.startPreview({\n        success: function success(a) {\n          __f__(\"log\", a, \" at pages/idphoto/idphoto.nvue:105\");\n          _this.camerastate = true;\n        }\n      });\n    },\n    //停止预览\n    stopPreview: function stopPreview() {\n      this.livePusher.stopPreview({\n        success: function success(a) {\n          _this.camerastate = false; //标记相机未启动\n        }\n      });\n    },\n    //状态\n    statechange: function statechange(e) {\n      //状态改变\n      __f__(\"log\", e, \" at pages/idphoto/idphoto.nvue:122\");\n      if (e.detail.code == 1007) {\n        _this.camerastate = true;\n      } else if (e.detail.code == -1301) {\n        _this.camerastate = false;\n      }\n    },\n    //返回\n    back: function back() {\n      uni.navigateBack();\n    },\n    //抓拍\n    snapshot: function snapshot() {\n      this.livePusher.snapshot({\n        success: function success(e) {\n          __f__(\"log\", e, \" at pages/idphoto/idphoto.nvue:139\");\n          __f__(\"log\", e.message.tempImagePath, \" at pages/idphoto/idphoto.nvue:140\");\n          _this.snapshotsrc = 'file:/' + e.message.tempImagePath;\n          __f__(\"log\", _this.snapshotsrc, \" at pages/idphoto/idphoto.nvue:143\");\n          // uni.saveFile({\n          // \ttempFilePath: _this.snapshotsrc,\n          // \tsuccess: function (res) {\n          // \t\tvar savedFilePath = res.savedFilePath;\n          // \t\tconsole.log('savedFilePath', savedFilePath);\n          // \t\t_this.snapshotsrc = savedFilePath\n          // \t\t_this.stopPreview();\n          // \t\t_this.setImage();\n          // \t\tuni.navigateBack();\n          // \t},\n          // \tfail: (err) => {\n          // \t\tconsole.log('err', err);\n          // \t},\n          // });\n          _this.stopPreview();\n          _this.setImage();\n          uni.navigateBack();\n        }\n      });\n    },\n    //反转\n    flip: function flip() {\n      this.livePusher.switchCamera();\n    },\n    //设置\n    setImage: function setImage() {\n      var pages = getCurrentPages();\n      var prevPage = pages[pages.length - 2]; //上一个页面\n      __f__(\"log\", prevPage, '上一个页面', \" at pages/idphoto/idphoto.nvue:175\");\n      //直接调用上一个页面的setImage()方法，把数据存到上一个页面中去\n      __f__(\"log\", _this.snapshotsrc, '_this.snapshotsrc', \" at pages/idphoto/idphoto.nvue:177\");\n      prevPage.$vm.setImage({\n        path: _this.snapshotsrc,\n        dotype: this.dotype\n      });\n    }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 10)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///9\n");
