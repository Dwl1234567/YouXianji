<template>
	<view>
		...
		<view class="bg-white scroll-tab-view" v-if="!barShow">
		...
		<!--Tab栏占位-->
		<view class="scroll-height-view" v-if="!barShow"/>
		
		<!--商品简介-->
		<view class="bg-white padding goods-synopsis-view">
			<view class="user-view">
				<view class="cu-avatar sm round" style="background-image:url(/static/delect_images/avatar/1.jpg)"/>
				<view class="text-black text-name">强哥11</view>
			...
			<view class="text-sm margin-top-sm map-view">
		...
		<!--服务-->
		<view class="margin-top padding bg-white service-view-box">
		...
		<!--商品详情-->
		<view class="margin-top padding bg-white details-view-box">
			...
			<view class="text-black text-content-view">iphoneX,美版256G,原装正品，无拆修，配件齐全，功能正常使用</view>
			
			<view class="img-box">
				<image src="/static/delect_images/home/goods/11.png" mode="widthFix"/>
				<image src="/static/delect_images/home/goods/12.png" mode="widthFix"/>
			</view>
			...
			<view class="bg-white steps-view">
		...
		<!--关于卖家-->
		<view class="margin-top bg-white selll-user-view-box">
			<view class="padding text-black text-lg">关于卖家</view>
			<view class="cu-list menu-avatar ">
				<view class="cu-item">
					<view class="cu-avatar round" style="background-image:url(/static/delect_images/avatar/1.jpg);"/>
					<view class="content">
						<view class="text-black">
							<view class="text-cut">强哥</view>
			...
			<view class="padding grid-tab-view">
		...
		<!--互动-->
		<view class="margin-top padding bg-white interaction-view-box">
			...
			<view class="interaction-view" v-else>
				...
				<view class="interaction-list-view">
					...
					<view class="list-itme">
						<view class="cu-avatar round" style="background-image:url(/static/delect_images/avatar/3.jpg);"/>
						<view class="view-box">
							<view class="title-box">
								<text class="margin-right-xs">强哥33</text>
					...
					<view class="list-itme">
						<view class="cu-avatar round" style="background-image:url(/static/delect_images/avatar/4.jpg);"/>
						<view class="view-box">
							<view class="title-box">
								<text class="margin-right-xs">强哥444</text>
		...
		<!--您推荐同型号已验机商品-->
		<view class="margin-top padding bg-white recommend-goods-box">
			<view class="text-black">为您推荐同型号已验机商品</view>
			<view class="margin-top goods-info-box">
				<view class="goods-img-view">
					<view class="cu-avatar radius lg" style="background-image:url(/static/delect_images/home/goods/1.png);"/>
		...
		<view class="margin-tb resemble-goods-box">
			...
			<view class="grid col-2">
				...
				<view class="grid-item-box">
					<view class="bg-white item-view">
						<view class="cu-avatar radius lg" style="background-image:url(/static/delect_images/home/goods/4.png);"/>
						<view class="padding-sm text-view">
							<view class="text-cut text-black text-sm">99新 苹果 iPhoneX 256G 银色</view>
							<view class="text-sm text-gray text-cut tag-view-box">
								<text>银色</text> <text>256G</text>
				...
				<view class="grid-item-box">
					<view class="bg-white item-view">
						<view class="cu-avatar radius lg" style="background-image:url(/static/delect_images/home/goods/11.png);"/>
						<view class="padding-sm text-view">
							<view class="text-cut text-black text-sm">99新 苹果 iPhoneX 256G 银色</view>
							<view class="text-sm text-gray text-cut tag-view-box">
								<text>银色</text> <text>256G</text>
				...
				<view class="grid-item-box">
					<view class="bg-white item-view">
						<view class="cu-avatar radius lg" style="background-image:url(/static/delect_images/home/goods/10.png);"/>
						<view class="padding-sm text-view">
							<view class="text-cut text-black text-sm">99新 苹果 iPhoneX 256G 银色</view>
							<view class="text-sm text-gray text-cut tag-view-box">
								<text>银色</text> <text>256G</text>
...
<style lang="scss">
	...
	/* #endif */
	@import "@/uni_modules/mpb-ui/shop/second_hand.scss";
</style>
