<template>
	<view>
		...
		<bar-title bgColor="bg-white" isBack>
			<block slot="content">
				<text class="margin-right-xs">强子</text>
		...
		<!--商品信息-->
		<view class="bg-white goods-details-box pay_status">
			...
			<!--提示-->
			<view class="goods-tip-view" :class="tipShow?'show':''">
				<text class="text-black cuIcon-notification icon"/>
				<view class="text-sm content">
					<text class="text-black">绝对不会收取实名认证等任何费用。让你加微信支付或者点链接、扫二维码的都是骗子！</text>
					<text class="text-blue">查看骗术></text>
				</view>
			</view>
			
			<!--按钮-->
			<view class="goods-info-btn-view" @tap="tipShowTap">
			...
			<scroll-view scroll-into-view="news15" scroll-y class="scroll-view" @scroll="chatScroll" :scroll-top="scroll_top">
				...
				<view id="news14" class="news-view-item left">
					...
					<view class="news-content">
						<view class="bg-white text-black content">
							<text>测试</text>
							<image class="emoji" src="/static/delect_images/emoji_1/1.png" mode="widthFix"/>
							<text>表情的</text>
						</view>
					</view>
				</view>
				...
				<view id="news15" class="news-view-item right">
					<view class="news-content">
						<view class="bg-blue content">
							<text class="text-sm text-gray status">已读</text>
							<text>测试</text>
							<image class="emoji" src="/static/delect_images/emoji/1.png" mode="widthFix"/>
							<text>表情的</text>
						</view>
					</view>
					<view class="cu-avatar round" style="background-image:url(/static/images/avatar/2.jpg);"/>
		...
		<view class="bg-white footer-fixed foot-padding-bottom">
					...
					<swiper class="emoji-swiper" :current="emoji_swiper" indicator-dots @change="emoji_change">
						...
						<swiper-item>
							<view class="cu-list grid no-border">
								...
								<image class="del_btn" src="/static/img/aa2.png" mode="widthFix" @tap="emojiDelTap"/>
							</view>
						</swiper-item>
					</swiper>
				</view>
			...
			<view class="tools-view" :class="toolsShow?'show':''">
				<view class="cu-list grid col-4 no-border">
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="/static/delect_images/news/az2.png" mode="widthFix"/>
						</view>
						<text>拍照</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="/static/delect_images/news/ayy.png" mode="widthFix"/>
						</view>
						<text>相册</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="/static/delect_images/news/azf.png" mode="widthFix"/>
						</view>
						<text>语音通话</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="/static/delect_images/news/aze.png" mode="widthFix"/>
						</view>
						<text>视频</text>
					</view>
					<view class="cu-item">
						<view class="img-view">
							<image class="img" src="/static/delect_images/news/az3.png" mode="widthFix"/>
						</view>
						<text>宝贝</text>
					</view>
				</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				goods_img: '/static/delect_images/home/goods/10.png', 
				scroll_top: 0, 
				tipShow: false, 
				chatShow: false, 
				speedyShow: false,
		...
		methods: {
			getEmojiUrl(index) {
				...
				let num = index + 1;
				let url = "/static/delect_images/" + this.emojiUrl + "/" + num + ".png";
				return url;
			},
			tipShowTap() {
				if(this.tipShow) {
...
<style lang="scss">
	...
	/* #endif */
	@import "@/uni_modules/mpb-ui/shop/chat.scss";
</style>
