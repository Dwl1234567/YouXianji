<template>
	<view>
		...
		<!--状态图标-->
		<view class="bg-white padding solid-top text-center status-img-view" v-if="basics == 4 && !cancel">
		...
		<!--广告区域-->
		<view class="bg-white card-box" v-if="basics == 0">
			<view class="card-view goods-ad-view">
		...
		<view class="bg-white card-hight-box"/>
		...
		<!--推荐列表-->
		<view class="recommend-goods-list-view">
			<view class="flex flex-wrap">
		...
		<view class="bg-white footer-fixed foot-padding-bottom" v-if="basics == 0">
		...
		<view class="bg-white footer-fixed foot-padding-bottom" v-if="basics == 1">
			<button class="cu-btn bg-orange sm" @tap="nextTap">测试下一步</button>
			<button class="cu-btn line-black radius">申请退款</button>
			<button class="cu-btn bg-red">提醒发货</button>
		</view>
		
		<view class="bg-white footer-fixed foot-padding-bottom" v-if="basics == 2">
			<button class="cu-btn bg-orange sm" @tap="nextTap">测试下一步</button>
			<button class="cu-btn line-black radius">申请退款</button>
		</view>
		
		<view class="bg-white footer-fixed foot-padding-bottom" v-if="basics == 3">
			<button class="cu-btn bg-orange sm" @tap="nextTap">测试下一步</button>
			<button class="cu-btn line-black radius">申请退款</button>
			<button class="cu-btn bg-red" @tap="confirmReceipt">确认收货</button>
		</view>
		
		<view class="bg-white footer-fixed foot-padding-bottom" v-if="basics == 4">
...
<style lang="scss">
	...
	/* #endif */
	@import "@/uni_modules/mpb-ui/shop/order-details.scss";
</style>
