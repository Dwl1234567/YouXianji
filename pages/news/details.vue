<template>
	<view>
		...
		<!--文章标题-->
		<view class="text-black text-bold text-lg title">提升幸福感的居家好物</view>
		<view class="text-gray text-sm text-right margin-lr right-text">
			<text>浏览38439</text>
			<text>关注38439</text>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				bg_img: '/static/delect_images/home/goods/1.png', content: {},
			}
		},
		onLoad() {
