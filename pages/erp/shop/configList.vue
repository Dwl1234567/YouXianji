			...
			<view v-for="(item, index) in dataList" style="display: flex; align-items: center; margin-bottom: 10px">
				...
				<view class="group_3 flex-col" @tap="goTap(item)">
					...
					<view class="section_1 flex-row">
						<view class=""></view>
						<image
							:src="$httpImage + item.fittingsPhoto"
							mode="aspectFit"
							class="cu-avatar lg radius box_5 flex-col"
						></image>
						<view class="text-wrapper_2 flex-col">
							<text class="text_8">{{item.fittingsName}}</text>
							<text class="text_9">颜色：{{item.fittingsColor}}</text>
						</view>
					</view>
					<view class="button">
...
<script>
	import Vue from 'vue';
	import { fittingsConfigList, undersell, putaway } from '@/api/erp.js';
