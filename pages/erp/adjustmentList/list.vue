						...
						<view class="section_1 flex-row">
							...
							<view class="text-wrapper_2 flex-col">
								...
								<view style="display: flex">
									<text class="text_10">销售价:{{item.oldSellPrice}}</text>
									<text class="text_10">调拨价:{{item.oldAllotPrice}}</text>
									<text class="text_10">成本价:{{item.oldRecyclePrice}}</text>
								</view>
								<view style="display: flex">
									<text class="text_10" style="border: 1rpx solid #d8d8d8; padding: 3.8rpx">
										销售价:{{item.sellPrice}}
									</text>
									<text class="text_10" style="border: 1rpx solid #d8d8d8; padding: 3.8rpx">
										调拨价:{{item.allotPrice}}
