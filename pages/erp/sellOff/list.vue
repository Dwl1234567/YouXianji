	...
	<view>
		...
		<view class="bottomView">
			<view class="totalNumber">
				总数量：{{wareCount.totalCount}}
			</view>
			<view class="totalCost">
				总价值：{{wareCount.totalUnderSellPrice ? wareCount.totalUnderSellPrice : 0}}
			</view>
		</view>
		<!-- 下拉加载提示 -->
	...
	export default {
		...
		methods: {
			...
			erpproductgetlistFuc() {
				...
				selectUndersellList(paramsData).then(res => {
					let data = res.rows;
