						...
						<view v-for="(item1,index1) in item.goodslist" :key="index1" @tap="prodoctTap(item1.id)">
							...
							<view class="flex">
								<view class="flex-sub padding-sm radius">
									<view class="goodsimg" :style="[{backgroundImage:'url('+item1.image+')'}]"></view>
								</view>
...
<script>
	import { erppurchasegetlist } from '@/api/erpapi.js';
	import { selectRecycleOrderList } from '@/api/erp.js';
